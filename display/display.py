...
class Display(object):
    ...
    #     pygame.display.set_caption(self.GAMENAME)
    #     pygame.mouse.set_visible(True)
    #     self.background_image = pygame.transform.scale(pygame.image.load(Directory().get_directory() + "/images/intro/premenu.png"), (self.WIN_WIDTH, self.WIN_HEIGHT)) # Tutorial background
    #     self.screen.blit(self.background_image, (0,0))
